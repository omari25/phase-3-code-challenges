...
# ***********************************************************
# Create Roles Here
producer = Role.create(salary: 303_000, character_name: "Omar", actor: tina_fey, movie: mean_girls)
director = Role.create(salary: 250_000, character_name: "Mahat", actor: posh_spice, movie: mean_girls)
designer = Role.create(salary: 270_000, character_name: "Abdul", actor: baby_spice, movie: spice_world)
